...
public class CSVWriterThread implements Runnable {
    ...
    // contructor for writing only one object to file
    protected CSVWriterThread(Object objectToWrite, String path, boolean append, String[] template) {
    ...
    // constructor for writing several objects to file
    protected <T> CSVWriterThread(ObservableList<T> data, String path, boolean append, String[] template) {
    ...
    public void run() {
        ...
        try {
            writeObject();
            // Exceptions thrown to run must be handled here
